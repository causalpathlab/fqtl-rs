...
//!
//! Wraps `crate::candle_util::sgvb::cavi_susie` to produce `BlockFitResult` output.

use crate::candle_util::candle_core::Device;
use crate::candle_util::sgvb::cavi_susie::{cavi_susie, CaviSusieParams};
use crate::matrix_util::traits::ConvertMatOps;
use anyhow::Result;
...
pub fn fit_block_cavi(
    ...
    for tt in 0..t {
        ...
        let y_tensor = crate::candle_util::candle_core::Tensor::from_slice(
            y_col.as_slice(),
            (y_col.len(),),
            &device,
        )?;
