...
use fqtl_rs::matrix_util::common_io::mkdir_parent;
use fqtl_rs::matrix_util::traits::MatOps;
use log::info;
use nalgebra::DMatrix;
use rayon::prelude::*;

use fqtl_rs::sgvb::cavi_fit::fit_block_cavi;
use fqtl_rs::sgvb::{fit_block, BlockFitResult, ComputeDevice, FitConfig, ModelType, PriorType};
use fqtl_rs::summary_stats::common::{
...
use fqtl_rs::summary_stats::polygenic_score::compute_all_polygenic_scores_ridge;
...
fn build_sgvb_config(
    ...
    let batch_size = args
        .batch_size
        .unwrap_or_else(|| fqtl_rs::matrix_util::utils::default_block_size(num_variants));
    FitConfig {
