...
use fqtl_rs::candle_util::candle_nn::{Optimizer, VarBuilder, VarMap};
use fqtl_rs::matrix_util::traits::IoOps;
use log::info;
use std::fs::File;
use std::io::{BufRead, BufReader};
use std::path::{Path, PathBuf};

use fqtl_rs::candle_util::sgvb::{
...
fn run_gaussian_gaussian(ctx: RegressionContext) -> Result<()> {
    ...
    let mut optimizer = fqtl_rs::candle_util::candle_nn::AdamW::new_lr(varmap.all_vars(), args.lr)?;
