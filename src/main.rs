...
fn print_logo() {
    ...
    println!("  {}", "fqtl".bold());
    println!("  {}", "functions for QTL analysis".dimmed());
    println!();
}

#[derive(Parser)]
#[command(name = "fqtl")]
#[command(about = "fqtl: functions for QTL analysis")]
struct Cli {
...
fn main() -> Result<()> {
    ...
    let default_filter = if cli.verbose {
        fqtl_rs::matrix_util::common_io::VERBOSE_LOG_FILTER
    } else {
        fqtl_rs::matrix_util::common_io::QUIET_LOG_FILTER
    };
