...
use crate::mcmc_util::engine::traits::EssParamSummary;
use crate::mcmc_util::engine::{elliptical_slice_step, McmcConfig, McmcModel};
...
pub fn mcmc_sparse<P: ComponentPrior>(
    ...
    crate::mcmc_util::engine::run_mcmc(&model, config)
}
