...
use crate::mcmc_util::engine::McmcConfig;
use crate::mcmc_util::sparse_regression::{
...
impl RssBlockFitter for McmcSampler {
    fn fit_block(
        ...
        for tt in 0..t {
            ...
            let std_beta =
                crate::mcmc_util::sparse_regression::compute_posterior_std_beta(&result.samples, p);
