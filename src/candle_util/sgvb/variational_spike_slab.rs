...
mod tests {
    ...
    fn test_sparse_recovery() -> Result<()> {
        use crate::candle_util::sgvb::traits::BlackBoxLikelihood;
        use crate::candle_util::sgvb::{FixedGaussianPrior, RegressionSGVB, SGVBConfig};
        ...
        for _ in 0..500 {
            let loss = crate::candle_util::sgvb::local_reparam_loss(&model, &likelihood, 30, 1.0)?;
