...
//!
//! This is the CPU-only equivalent of `crate::candle_util::sgvb::RssSvd`, using
//! `crate::matrix_util::traits::RandomizedAlgs::rsvd` for the randomized SVD.
//!
//! # Model
//!
...
use crate::matrix_util::traits::RandomizedAlgs;
use anyhow::Result;
