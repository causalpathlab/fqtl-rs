use crate::matrix_util::common_io::{Delimiter, ReadLinesOut};
...
pub trait SampleOps {
    ...
    /// `seed`. See [`crate::matrix_util::rand_util`].
...
pub trait IoOps {
        ...
        <Self::Scalar as std::str::FromStr>::Err: std::fmt::Debug,
    {
        ...
        let ReadLinesOut { mut lines, header } =
            crate::matrix_util::common_io::read_lines_of_words_delim(file_path, delim, hdr_line)?;
