...
//!
//! Run: cargo test -p fqtl-rs --test num_components_fp -- --nocapture

use anyhow::Result;
use fqtl_rs::candle_util::candle_core::{DType, Device, Tensor};
use fqtl_rs::candle_util::sgvb::cavi_susie::{cavi_susie, CaviSusieParams};
use fqtl_rs::matrix_util::traits::MatOps;
use fqtl_rs::sgvb::{fit_block, BlockFitResult, FitConfig, ModelType};
